...
def bedrock_generate(report_prompt: str):
    ...
    resp = bedrock.invoke_model(
        modelId=MODEL_ID,  # example: "amazon.nova-lite-v1:0"
    ...
    # Nova returns output text inside payload["output"]["message"]["content"]
    return "".join([c.get("text", "") for c in payload["output"]["message"]["content"]])
